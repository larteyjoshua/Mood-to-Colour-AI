...
st.title("POEM'S MOOD TO COLOUR APP")
st.sidebar.title("About Developer")
st.sidebar.header("Name: ")
st.sidebar.subheader("Lartey Joshua")
st.sidebar.header("Email: ")
st.sidebar.subheader("larteyjoshua@gmail.com")
st.sidebar.header("github: ")
st.sidebar.subheader("github.com/larteyjoshua")
st.sidebar.header("Whatsapp: ")
st.sidebar.subheader("+233249643365")




st.header("Please Enter the sentence or the poem")
...
if st.button("Check"):
    ...
    def main():
        ...
        st.write("Let me think about that for a moment..")
        # engine = pyttsx3.init()
        ...
        with st.spinner("Please Wait........."):
            ...
            # Update the progress bar with each iteration.
                latest_iteration.text(f'THINKING... {i+1}')
                bar.progress(i + 1)
                time.sleep(0.1)
        ...
        if sentimentValue is 1:
            print("Happy!")
            print("That line made me happy!")
            st.success("Happy")
            st.write("That line made me happy!")
            # engine = pyttsx3.init()
            # engine.say("That line made me happy!")
            # engine.runAndWait()
        ...
        # if sentiment is angry/sad, the trained AI chooses a sad color and draws a picture
            ...
            print("Angry!")
            print("That line made me Sad!")
            st.warning("Angry")
            st.write("That line made me sad!")
            # engine = pyttsx3.init()
            # engine.say("That line made me angry!")
            # engine.runAndWait()
        ...
        # Else the picture is neutral and the trained AI draws a meh picture
            ...
            print("Meh")
            print("That line was meh!")
            st.info("Meh")
            st.write("That line was meh!")
            #engine = pyttsx3.init()
            #engine.say("That line was meh!")
            #engine.runAndWait()
            testImage = Image.new("RGB", (10, 10), (255, 255, 255))
            pixel = testImage.load()
